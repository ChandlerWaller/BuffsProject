# Generated by Django 4.2 on 2024-04-04 23:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portfolio', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='buffs_app.portfolio')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('portfolio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='buffs_app.portfolio')),
            ],
        ),
    ]
